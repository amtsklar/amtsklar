  ...
  return (
    <div style={S.page}>
      ...
      <div style={S.body}>
        ...
        <ul style={S.ul}>
          <li style={S.li}><strong style={{ color: '#EDF2FA' }}>Art der Daten:</strong> Der von dir eingegebene Brieftext (ggf. personenbezogen)</li>
          <li style={S.li}><strong style={{ color: '#EDF2FA' }}>Rechtsgrundlage:</strong> Art. 6 Abs. 1 lit. b DSGVO (Vertragserfüllung) sowie Art. 6 Abs. 1 lit. a DSGVO (Einwilligung durch aktive Nutzung)</li>
          <li style={S.li}><strong style={{ color: '#EDF2FA' }}>Speicherung:</strong> Der Brieftext wird von AmtsKlar weder gespeichert noch protokolliert. Er wird ausschließlich für die Dauer der Analyse an Anthropic übermittelt.</li>
          <li style={S.li}><strong style={{ color: '#EDF2FA' }}>Hinweis:</strong> Entferne vor der Analyse sensible persönliche Daten (z.B. Sozialversicherungsnummer, Bankdaten) soweit möglich.</li>
        </ul>
        ...
        <ul style={S.ul}>
          <li style={S.li}><strong style={{ color: '#EDF2FA' }}>Art der Daten:</strong> E-Mail-Adresse</li>
          <li style={S.li}><strong style={{ color: '#EDF2FA' }}>Rechtsgrundlage:</strong> Art. 6 Abs. 1 lit. b DSGVO (Vertragserfüllung)</li>
          <li style={S.li}><strong style={{ color: '#EDF2FA' }}>Speicherung:</strong> Lokal in deinem Browser (localStorage) zur Vermeidung wiederholter Eingabe. Keine Speicherung auf unseren Servern.</li>
        </ul>
        ...
        <ul style={S.ul}>
          <li style={S.li}><strong style={{ color: '#EDF2FA' }}>Art der Daten:</strong> Numerischer Zähler (keine personenbezogenen Daten)</li>
          <li style={S.li}><strong style={{ color: '#EDF2FA' }}>Speicherort:</strong> Ausschließlich lokal in deinem Browser</li>
          <li style={S.li}><strong style={{ color: '#EDF2FA' }}>Löschung:</strong> Durch Löschen der Browser-Daten jederzeit möglich</li>
        </ul>
        ...
        <ul style={S.ul}>
          <li style={S.li}><strong style={{ color: '#EDF2FA' }}>Rechtsgrundlage:</strong> Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an Betriebssicherheit)</li>
          <li style={S.li}><strong style={{ color: '#EDF2FA' }}>Speicherdauer:</strong> Gemäß Cloudflare-Policy, maximal 30 Tage</li>
        </ul>
        ...
        <div style={S.box}>
          ...
          <p style={{ ...S.p, marginBottom: 0 }}>
            <strong style={{ color: '#EDF2FA' }}>Zweck:</strong> Verarbeitung des Brieftexts zur KI-gestützten Analyse<br />
            <strong style={{ color: '#EDF2FA' }}>Sitz:</strong> 548 Market St, San Francisco, CA 94104, USA<br />
            <strong style={{ color: '#EDF2FA' }}>Datenschutz:</strong> <a href="https://www.anthropic.com/privacy" target="_blank" rel="noopener noreferrer" style={S.a}>anthropic.com/privacy</a><br />
            <strong style={{ color: '#EDF2FA' }}>Drittlandtransfer:</strong> Datenverarbeitung in den USA. Grundlage für den Transfer: Standardvertragsklauseln gemäß Art. 46 Abs. 2 lit. c DSGVO. Anthropic verpflichtet sich zur Einhaltung dieser Klauseln im Rahmen seiner API-Nutzungsbedingungen.<br />
            <strong style={{ color: '#EDF2FA' }}>Speicherung durch Anthropic:</strong> Laut Anthropic API-Nutzungsbedingungen werden API-Eingaben nicht für das Training von Modellen verwendet und nicht dauerhaft gespeichert (gültig ab API-Version 2023-06-01). Wir empfehlen, die aktuellen Anthropic-Datenschutzbestimmungen zu prüfen.
          </p>
        </div>
        ...
        <div style={S.box}>
          ...
          <p style={{ ...S.p, marginBottom: 0 }}>
            <strong style={{ color: '#EDF2FA' }}>Zweck:</strong> Abonnementverwaltung, Zahlungsabwicklung, Rechnungsstellung<br />
            <strong style={{ color: '#EDF2FA' }}>Sitz:</strong> 15 Hollowell Road, Milton Malsor, Northampton, England, NN7 3AB<br />
            <strong style={{ color: '#EDF2FA' }}>Handelsregister:</strong> England und Wales, Nr. 10212606<br />
            <strong style={{ color: '#EDF2FA' }}>Datenschutz:</strong> <a href="https://www.paddle.com/legal/privacy" target="_blank" rel="noopener noreferrer" style={S.a}>paddle.com/legal/privacy</a><br />
            <strong style={{ color: '#EDF2FA' }}>Hinweis:</strong> Paddle ist Merchant of Record und eigenständig datenschutzrechtlich verantwortlich für Zahlungsdaten. AmtsKlar hat keinen Zugriff auf Zahlungsdaten.
          </p>
        </div>
        ...
        <div style={S.box}>
          ...
          <p style={{ ...S.p, marginBottom: 0 }}>
            <strong style={{ color: '#EDF2FA' }}>Zweck:</strong> Hosting der Website, Content Delivery Network, DDoS-Schutz, SSL<br />
            <strong style={{ color: '#EDF2FA' }}>Sitz:</strong> 101 Townsend St, San Francisco, CA 94107, USA<br />
            <strong style={{ color: '#EDF2FA' }}>Datenschutz:</strong> <a href="https://www.cloudflare.com/privacypolicy/" target="_blank" rel="noopener noreferrer" style={S.a}>cloudflare.com/privacypolicy</a><br />
            <strong style={{ color: '#EDF2FA' }}>Drittlandtransfer:</strong> Cloudflare verarbeitet Daten auch in der EU (Cloudflare verfügt über EU-Rechenzentren). Für US-Transfers: EU-US Data Privacy Framework (Angemessenheitsbeschluss 2023) sowie Standardvertragsklauseln.
          </p>
        </div>
        ...
        <p style={S.p}>
          AmtsKlar setzt <strong style={{ color: '#EDF2FA' }}>keine</strong> Werbe- oder
        ...
        <ul style={S.ul}>
          <li style={S.li}><strong style={{ color: '#EDF2FA' }}>Brieftext:</strong> Nicht gespeichert — wird ausschließlich für die Dauer der Analyse verarbeitet</li>
          <li style={S.li}><strong style={{ color: '#EDF2FA' }}>E-Mail-Adresse:</strong> Lokal im Browser bis zur manuellen Löschung; auf Anfrage sofortige Löschung</li>
          <li style={S.li}><strong style={{ color: '#EDF2FA' }}>Zahlungsdaten:</strong> Gemäß den Datenschutzbestimmungen von Paddle, gesetzliche Aufbewahrungsfristen (7 Jahre für Buchungsbelege)</li>
          <li style={S.li}><strong style={{ color: '#EDF2FA' }}>Server-Logs:</strong> Maximal 30 Tage (Cloudflare)</li>
        </ul>
        ...
        <ul style={S.ul}>
          <li style={S.li}><strong style={{ color: '#EDF2FA' }}>Auskunftsrecht (Art. 15 DSGVO):</strong> Recht auf Auskunft über verarbeitete personenbezogene Daten</li>
          <li style={S.li}><strong style={{ color: '#EDF2FA' }}>Berichtigungsrecht (Art. 16 DSGVO):</strong> Recht auf Berichtigung unrichtiger Daten</li>
          <li style={S.li}><strong style={{ color: '#EDF2FA' }}>Recht auf Löschung (Art. 17 DSGVO):</strong> Recht auf Löschung deiner Daten, soweit keine gesetzlichen Aufbewahrungspflichten entgegenstehen</li>
          <li style={S.li}><strong style={{ color: '#EDF2FA' }}>Recht auf Einschränkung (Art. 18 DSGVO):</strong> Recht auf Einschränkung der Verarbeitung</li>
          <li style={S.li}><strong style={{ color: '#EDF2FA' }}>Widerspruchsrecht (Art. 21 DSGVO):</strong> Recht auf Widerspruch gegen die Verarbeitung</li>
          <li style={S.li}><strong style={{ color: '#EDF2FA' }}>Recht auf Datenübertragbarkeit (Art. 20 DSGVO):</strong> Recht auf Erhalt deiner Daten in einem strukturierten Format</li>
          <li style={S.li}><strong style={{ color: '#EDF2FA' }}>Recht auf Widerruf einer Einwilligung (Art. 7 Abs. 3 DSGVO):</strong> Jederzeit mit Wirkung für die Zukunft</li>
        </ul>
        <p style={S.p}>
        ...
        <div style={S.box}>
          <p style={{ ...S.p, marginBottom: 0 }}>
            <strong style={{ color: '#EDF2FA' }}>Österreichische Datenschutzbehörde</strong><br />
